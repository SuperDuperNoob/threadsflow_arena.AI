...
-- persona_topics real columns: topic, angle_hint, time_of_day (text[]), niche_tags (text[]),
-- context (jsonb). We map: angle->angle_hint, tone->niche_tags[1], psychology_technique->niche_tags[2],
-- time_of_day->ARRAY[time_of_day].
INSERT INTO persona_topics (source_id, topic, angle_hint, time_of_day, niche_tags)
SELECT id, topic, angle_hint, ARRAY[time_of_day] AS time_of_day, ARRAY[tone, psychology_technique] AS niche_tags
...
) AS v(topic, angle_hint, time_of_day, tone, psychology_technique);
